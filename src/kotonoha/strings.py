...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "weight.thin": {"en": "Thin", "zh-Hans": "极细", "zh-Hant": "極細", "ja": "シン"},
    "weight.extralight": {"en": "Extra light", "zh-Hans": "特细", "zh-Hant": "特細", "ja": "エクストラライト"},
    "weight.light": {"en": "Light", "zh-Hans": "细体", "zh-Hant": "細體", "ja": "ライト"},
    "weight.regular": {"en": "Regular", "zh-Hans": "常规", "zh-Hant": "標準", "ja": "レギュラー"},
    "weight.medium": {"en": "Medium", "zh-Hans": "中等", "zh-Hant": "中等", "ja": "ミディアム"},
    "weight.semibold": {"en": "Semibold", "zh-Hans": "半粗", "zh-Hant": "半粗", "ja": "セミボールド"},
    "weight.bold": {"en": "Bold", "zh-Hans": "粗体", "zh-Hant": "粗體", "ja": "ボールド"},
    "weight.extrabold": {"en": "Extra bold", "zh-Hans": "特粗", "zh-Hant": "特粗", "ja": "エクストラボールド"},
    "weight.black": {"en": "Black", "zh-Hans": "超粗", "zh-Hant": "超粗", "ja": "ブラック"},

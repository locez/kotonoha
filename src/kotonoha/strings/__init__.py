...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "overlay.offset.earlier": {"en": "Move lyrics earlier by 100 ms", "zh-Hans": "歌词提前 100 毫秒",
                                "zh-Hant": "歌詞提前 100 毫秒", "ja": "歌詞を 100 ms 早める"},
    "overlay.offset.later": {"en": "Move lyrics later by 100 ms", "zh-Hans": "歌词延后 100 毫秒",
                              "zh-Hant": "歌詞延後 100 毫秒", "ja": "歌詞を 100 ms 遅らせる"},
    ...
    "set.tray_icon_hint": {"en": "Shown in the system tray. White or black suit a dark or light panel.",
                           "zh-Hans": "显示在系统托盘。白色/黑色分别适合深色/浅色任务栏。",
                           "zh-Hant": "顯示在系統匣。白色/黑色分別適合深色/淺色工作列。",
                           "ja": "システムトレイに表示。白/黒はダーク/ライトのパネルに合います。"},
    "set.window_icon": {"en": "Window icon", "zh-Hans": "窗口图标", "zh-Hant": "視窗圖示", "ja": "ウィンドウアイコン"},
    "set.window_icon_hint": {"en": "Shown in the taskbar and window switcher.",
                             "zh-Hans": "显示在任务栏和窗口切换器。",
                             "zh-Hant": "顯示在工作列與視窗切換器。",
                             "ja": "タスクバーとウィンドウスイッチャーに表示されます。"},
    ...
    "set.fx_transition": {"en": "Line transition", "zh-Hans": "换行动画",
                          "zh-Hant": "換行動畫", "ja": "行の切替効果"},
    "fxtrans.fade": {"en": "Fade", "zh-Hans": "淡入", "zh-Hant": "淡入", "ja": "フェード"},
    "fxtrans.rise": {"en": "Rise", "zh-Hans": "上浮", "zh-Hant": "上浮", "ja": "ライズ"},
    "fxtrans.slide": {"en": "Slide", "zh-Hans": "滑入", "zh-Hant": "滑入", "ja": "スライド"},
    "fxtrans.zoom": {"en": "Zoom", "zh-Hans": "缩放", "zh-Hant": "縮放", "ja": "ズーム"},
    ...
    "set.current_line_only": {"en": "Show current line only", "zh-Hans": "仅显示当前播放行",
                               "zh-Hant": "僅顯示目前播放行", "ja": "現在の行だけ表示"},
    "set.current_line_only_hint": {
        "en": "Hide the previous and next lyric lines.",
        "zh-Hans": "隐藏前后歌词行。",
        "zh-Hant": "隱藏前後歌詞行。",
        "ja": "前後の歌詞行を隠します。",
    },
    ...
    "set.interlude_style": {"en": "Interlude marker", "zh-Hans": "间奏标记",
                            "zh-Hant": "間奏標記", "ja": "間奏の表示"},
    "set.interlude.dots": {"en": "Filling dots", "zh-Hans": "渐亮圆点",
                           "zh-Hant": "漸亮圓點", "ja": "点が増える"},
    "set.interlude.symbol": {"en": "Still note", "zh-Hans": "静态音符",
                             "zh-Hant": "靜態音符", "ja": "音符のまま"},
    "set.interlude_countdown": {"en": "Interlude countdown", "zh-Hans": "间奏倒计时",
                                "zh-Hant": "間奏倒數", "ja": "間奏のカウントダウン"},
    "set.interlude.count_off": {"en": "None", "zh-Hans": "不显示", "zh-Hant": "不顯示", "ja": "表示しない"},
    "set.interlude.count_percent": {"en": "Percent", "zh-Hans": "百分比", "zh-Hant": "百分比", "ja": "パーセント"},
    "set.interlude.count_seconds": {"en": "Seconds left", "zh-Hans": "剩余秒数",
                                    "zh-Hant": "剩餘秒數", "ja": "残り秒数"},
    "set.interlude_hint": {
        "en": "Shown where a song has no words: the run-up to the first line, "
              "an instrumental break, and after the last line.",
        "zh-Hans": "在歌曲没有歌词的位置显示：第一句之前、间奏，以及最后一句之后。",
        "zh-Hant": "在歌曲沒有歌詞的位置顯示：第一句之前、間奏，以及最後一句之後。",
        "ja": "歌詞がない箇所に表示します。最初の行の前、間奏、最後の行の後。",
    },

...
# Build the Kotonoha Wayland layer-shell bridge (libkoto-layer.so).
# Ported from BiliHUD's build_bridge.sh.
...
OUTPUT_FILE="$SCRIPT_DIR/libkoto-layer.so"
...
log_info "You can now run kotonoha."

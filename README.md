...
- On GNOME/Mutter Wayland, an unlocked overlay uses the compositor's system move gesture, so dragging does not send client-side window moves or save coordinates that the client cannot verify.
